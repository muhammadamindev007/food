...
function Login({ lang }) {
    ...
    function fnIn(e) {
        ...
        const finUser = data.find((item) =>
            item.name === user__list.name &&
            item.password === user__list.password
        )
...

            {
                show ?
                    ...
                    <div className="sign__up">
                        ...
                        <form
                            className='form-control w-75 m-auto form__login'
                            onSubmit={fnUp}
                        >

                            <input
                                type="text"
                                className='text-light form-control w-100 mt-3 login__control'
                                placeholder={lang === 'RU'
                                    ? 'введите свое имя'
                                    : 'ismingizni kiriting'}
                                name='name'
                            ...
                            <input
                                ...
                                className={
                                    confirm
                                        ? 'text-light form-control w-100 mt-3 login__control bg-danger'
                                        : 'text-light form-control w-100 mt-3 login__control'
                                }
                                placeholder={lang === 'RU'
                                    ? 'введите пароль'
                                    : 'parol kiriting'}
